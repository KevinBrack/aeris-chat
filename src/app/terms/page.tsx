      ...
      <div className="max-w-3xl mx-auto">
        ...
        <section className="space-y-6 text-foreground">
          ...
          <section className="space-y-4">
            ...
            <p>
              By accessing and using Aeris Chat (&ldquo;the Service&rdquo;), you
          ...
          <section className="space-y-4">
            ...
            <p>
              The Service is provided &ldquo;as is&rdquo;. We make no
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-primary">7. Contact</h2>
            <p>
